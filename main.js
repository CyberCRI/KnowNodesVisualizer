...
Renderer.init = function(centralNodeData, childrenNodesData){
    Renderer.engine.initParticleSystem();
    Renderer.canvas.init();
    if(!(centralNodeData && childrenNodesData))
        Renderer.engine.initData();
    else{
...
Renderer.engine.initData = function(){
    ...
    Renderer.layers.count = Math.ceil(this.jsonChildrenData.length / NODES_PER_LAYER);
};
Renderer.engine.initParticleSystem = function(){
    ...
    var pEdge = this.particleSystem.originalPruneEdge = this.particleSystem.pruneEdge;
    this.particleSystem.pruneEdge = function(e){e.data.edge.delete();};
    var pNode = this.particleSystem.originalPruneNode = this.particleSystem.pruneNode;
...
Renderer.Node.prototype = {
    ...
    delete: function(){
        this.displayGroup.destroyChildren();
